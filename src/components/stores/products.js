        ...
        return {
            products: [
                ...
                },
                {
                    ...
                    details: {
                        ...
                        customFields: {
                            ...
                            'Вид календаря': ['Календарь перекидной, формат А4', 'Календарь перекидной, формат А4'],
                            'Тираж': ['1-10 шт/руб', '11-50 шт/руб', '51-150 шт/руб', 'больше 125 шт/руб', 'больше 250 шт/руб'],
                        },
                    },
                    prices: [
                        imagesStore.images.flipCalendarsPrices,
                    ],
                    save: false
                },
                {
                    id: 102,
                    name: 'Календари домики',
                    link: 'Календари домики',
                    ...
                    prices: [
                        imagesStore.images.housesCalendarsPrices,
                    ],
                    save: false
                },
                {
                    id: 103,
                    name: 'Квартальные календари',
                    link: 'Квартальные календари',
                    ...
                    details: {
                        ...
                        customFields: { 
                            ...
                            'Вид календаря': ['Квартальный календарь А4. Без рекламного поля, без ламинирования', 'Квартальный календарь А4. Без рекламного поля, с ламинированием',
                                ...
                                'Квартальный календарь А4. С тремя рекламными полями, без ламинирования', 'Квартальный календарь А4. С тремя рекламными полями, с ламинированием',
                                'Квартальный календарь А4. Сетка А4, без ламинирования', 'Квартальный календарь А4. Сетка А4, с ламинированием'],
                            'Тираж': ['1-10 шт', '11-50 шт', '51-100 шт', '<101 шт'],
                        },
                    },
                    prices: [
                        imagesStore.images.quarterlyCalendarsPrices,
                    ],
                    save: false
                },
                {
                    ...
                    prices: [
                        imagesStore.images.pocketCalendarsPrices,
                    ],
                    save: false
                },
                {
                    ...
                    link: 'Полноцветная лазерная печать',
                ...
                },
                {
                    ...
                    name: 'Штендер',
                    link: 'Штендер',
                    img: imagesStore.images.stander,
                    category: 'Прочее',
                    description: "Ищете способ привлечь внимание? Наши баннеры и штендеры идеально подходят для рекламы на мероприятиях или в магазинах. Мы предлагаем различные размеры и материалы, а также возможность индивидуального дизайна. Высокое качество печати гарантировано!",
                    count: 'От 1 шт',
                    details: {
                ...
                },
                {
                    ...
                    link: 'Изготовление планшетов, табличек, стендов',
                    img: imagesStore.images.making,
                    category: 'Прочее',
                    ...
                    details: {
                        ...
                        customFields: {
                            'Тираж': ['от 1 шт'],
                            'Вид материала': ['Пластик ПВХ (2х3 м)', 'Пенакартон (1х1,40 м )', 'Кармашки (прозрачный пластик)',],
                            'Толщина материала': ['3 мм', '5 мм', ],
                            'Размеры':['А3', 'А4', 'А5']
                        },
                    },
                    prices: [
...

                {
                    ...
                    details: {
                        estimatedCostTitle: 'Ориентировочная стоимость',
                        estimatedCostPrice: '76 ₽',
                        customFields: {
                            'Тираж': ['50 шт', '100 шт', '150 шт', '200 шт', '300 шт', '400 шт', '500 шт', '1000 шт'],
                            'Цветность печати': ['1+0', '2+0', '1+1', '3+0', '2+1', '4+0', '3+1', '2+2']
                        },
                    },
                    prices: [
                ...
                },
                {
                    ...
                    link: 'Струйная печать фотографий',
